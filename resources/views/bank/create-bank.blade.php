<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('bank.read') }}" class="inline-flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400
    ...
    <div class="py-8">
        <div class="tf-wrap">
            ...
            <form action="{{ route('bank.store') }}" method="POST" class="tf-form">
                @csrf
                ...
                <div class="tf-card">
                    <div class="tf-card-head">
                        ...
                        <span class="tf-section-title">Masukkan Data Bank</span>
                    </div>
                    <div class="tf-card-body">

                        <div>
                            <label for="nasabah_id" class="tf-label">
                                Nama Bank <span class="tf-req">*</span>
                            </label>
                            <input type="text" id="nama_bank" name="nama_bank" value="{{ old('nama_bank') }}" placeholder="Contoh: BCA, Mandiri" class="tf-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="tf-actions">
                    <a href="{{ route('bank.read') }}" class="tf-btn-cancel">Batal</a>
